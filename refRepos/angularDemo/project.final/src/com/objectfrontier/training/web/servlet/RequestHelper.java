...
// if unable to convert AppErrCode, throw with original error response
    ...
    public  <T> List<T> requestList(String uri, Class< T> type) throws Exception { this.uri = uri; return requestList(type); }

    public  <T>  List<T> requestList(Class<T> type) throws Exception {
