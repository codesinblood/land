...
public class PersonFilterTest extends BaseServletTest {
    ...
    public void testRead(Long input, boolean flag, Person expected, List<ErrorCode> errorList) throws Exception {
        ...
        try {
            ...
            Person created = helper.setSecured(true)
                    ...
                    .setInput(null)
                    .requestObject("/do/person?id=" + input + "&&flag=" + flag, Person.class);
    ...
    public Object[][] dpRead() {
        ...
        long id =4;
        long negativeId =8;
        Person expected = new Person(4, "jan",  "ja", "ja1", "1585-02-03", "demo",  false,  new Address(6, "gandhi st",  "chennai", 123456));
        return new Object[][] {
