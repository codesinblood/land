...
public class PersonServiceTest {
    ...
    private void createPositiveTest(Person person, Person expected) throws SQLException, ParseException, IOException {
        ...
        conManager.releaseConnection(connection, true);
    }
    ...
    private void readPositiveTest(long id, boolean flag, Person expected) throws SQLException, IOException {
    ...
    private void readAllPositiveTest(List<Person> expected) throws SQLException, IOException {
    ...
    private void updatePositiveTest(Person person, Person expected) throws SQLException, ParseException, IOException {
    ...
    private void deletePositiveTest(Person person, int expected) throws SQLException, IOException {
    ...
    private void testCreate_negative(Person person, ErrorCode expected) throws SQLException, ParseException, IOException {

        Connection connection = conManager.getConnection ();
        try {
            personService.createPerson(connection, person);
        } catch (AppException e) {
            Assert.assertEquals(e.getErrorMsg(), expected.getMsg());
            conManager.releaseConnection(connection, false);
        }
    }

    @DataProvider
    private Object[][] dpCreateFnNull_negative() throws SQLException {
    ...
    private void deleteNegativeTest(Person person, String expected) throws SQLException, IOException {

        Connection connection = conManager.getConnection ();
        try {
            personService.delete(connection, person);
        } catch (AppException e) {
            Assert.assertEquals(e.getErrorMsg(), expected);
            conManager.releaseConnection(connection, false);
        }
    }
    ...
    private void readAllNegativeTest(String expected) throws SQLException, IOException {
    ...
    private void readNegativeTest(long id, boolean flag, String expected) throws SQLException, IOException {
    ...
    private void updateNegativeTest(Person person, String expected) throws SQLException, ParseException, IOException {
