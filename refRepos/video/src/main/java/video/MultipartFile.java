...
public class MultipartFile {
    ...
    public static MultipartFile fromPath(Path path) {
        return new MultipartFile().setFilepath(path);
    }

    public static MultipartFile fromFile(File file) {
        return new MultipartFile().setFilepath(file.toPath());
    }

    private MultipartFile setFilepath(Path filepath) {
        this.filepath = filepath;
        return this;
    }

    public MultipartFile with(HttpServletRequest httpRequest) {
        request = httpRequest;
        return this;
    }

    public MultipartFile with(HttpServletResponse httpResponse) {
