...
public class ErrorConstants {
    ...
    public static final String FILE_DOWNLOAD_ERROR = "Error while downloading file";
    ...
    public static final String VIDEO_ENCODE_ERROR = "Error while encoding video";
    public static final String INVALID_VIDEO_RANGE = "Range offset invalid. Video parsing failed";
