...
public enum ErrorCode {
    ...
    FILE_DOWNLOAD_ERROR(500, ErrorConstants.FILE_DOWNLOAD_ERROR),
    ...
    VIDEO_ENCODE_ERROR(500, ErrorConstants.VIDEO_ENCODE_ERROR),
    MAIL_SERVER_ERROR(500, ErrorConstants.MAIL_SERVER_ERROR),
    INVALID_VIDEO_RANGE(400,ErrorConstants.INVALID_VIDEO_RANGE);
