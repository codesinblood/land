 ...
 **/
@Configuration
public class MediaHandler implements EnvironmentAware {

	static Logger logger = LoggerFactory.getLogger(MediaHandler.class);
    ...
    public static String fileUpload(InputStream inputStream, String fileContent, String fileOriginalName) throws IOException {
        ...
        String localFileName = prepareLocalFileName(fileOriginalName);
     ...
     */
    private static String prepareLocalFileName(String fileOriginalName) {
    ...
    /**
     * Method to return the convert files to byte stream. 
     */
    public static byte[] convertMiscFilesToByte(String filePath) throws IOException {
    ...
    public static int getEncodedVideoSize(byte[] bytes) {
        return bytes.length;
    }
    
    public static String prepareBase64String(String contentType, 
                                             String encodedImgPrefix, 
                                             String encodedImgSuffix,
                                             String base64EncodedImage) {
        
        String encodedImage = new StringBuilder().append(encodedImgPrefix)
                .append(contentType)
                .append(encodedImgSuffix)
                .append(base64EncodedImage).toString();
        return encodedImage;
    }
}
